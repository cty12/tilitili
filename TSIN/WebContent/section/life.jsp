			...
			<nav class="navbar navbar-default" role="navigation" >
				<div class="col-md-6 col-md-offset-1" align="left">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href=""><font face="微软雅黑"> 生活 </font></a></li>
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1" >
			<div class="col-md-8">	
					<br>
					<h4>			
						&nbsp&nbsp<span class="glyphicon glyphicon-thumbs-up text-primary"></span><font face="微软雅黑"> 生活推荐</font> 
					</h4>
					<%
						videoDisplay.getSectionEightHighRecom("life");
					...
					<h4>			
						&nbsp&nbsp<span class="glyphicon glyphicon-repeat text-primary"></span><font face="微软雅黑"> 生活动态</font> 
					</h4>
					<%
						videoDisplay.getSectionLastFourHot("life");
						while(videoDisplay.getRs().next())
						{
					%>
					<div class="col-xs-3" align="center">
			...
			<div class="col-md-4">
				<br>
				<h4>			
					<font face="微软雅黑"> 生活排行</font> 
				</h4>
				<table class="table table-hover table-striped">
				<%
					videoDisplay.getSectionTenHighClick("life");
					int cnt = 1;
					while(videoDisplay.getRs().next())
					{
				%>
