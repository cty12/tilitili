	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1" >
			<div class="col-md-8">	
					<br>
					<h4>			
						&nbsp&nbsp<span class="glyphicon glyphicon-thumbs-up text-primary"></span><font face="微软雅黑"> 娱乐推荐</font> 
					</h4>
					<%
						videoDisplay.getSectionEightHighRecom("entertainment");
					...
					<h4>			
						&nbsp&nbsp<span class="glyphicon glyphicon-repeat text-primary"></span><font face="微软雅黑"> 娱乐动态</font> 
					</h4>
					<%
						videoDisplay.getSectionLastFourHot("entertainment");
						while(videoDisplay.getRs().next())
						{
					%>
					<div class="col-xs-3" align="center">
			...
			<div class="col-md-4">
				<br>
				<h4>			
					<font face="微软雅黑"> 娱乐排行</font> 
				</h4>
				<table class="table table-hover table-striped">
				<%
					videoDisplay.getSectionTenHighClick("entertainment");
					int cnt = 1;
					while(videoDisplay.getRs().next())
					{
				%>
