...
insert into video (title, path, icon, type, time, recent, click, praise, comment, nextcomment) values ('测试8', 'testvideo/8.flv', 'testimg/8.jpeg', 'entertainment', '2014-09-08 20:00', '2014-10-12 20:00', 750, 76, 0, 1s);
